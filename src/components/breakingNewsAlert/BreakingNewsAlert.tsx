const BreakingNewsAlert = () => {
  return (
    <div className="w-full sm:w-[1366px] sm:h-[80px] h-[181px] bg-red-700 flex gap-[20px] sm:gap-[60px] items-center justify-center font-Poppins mx-[24px] sm:flex-row flex-col">
