...
const NewsModal: React.FC<NewsModalProps> = ({
  ...
  return (
    <div className="w-full h-full flex justify-center items-center z-[50px] bg-black/40 fixed top-0  left-0">
      <div className="sm:p-[48px] py-[35px] px-[24px] sm:rounded-[20px] rounded-[10px] max-h-[846px] sm:min-h-[500px] flex flex-col sm:flex-row sm:gap-[76px] relative bg-white w-[327px] sm:w-[1462px] ">
        <div
          onClick={closeModal}
        ...
        <div>
          ...
          <div>
            ...
            <p className="sm:w-[500px]  sm:block sm:min-h-[94px] max-h-[162px] text-zinc-800 sm:text-[15px] text-[14px] font-normal font-Poppins leading-normal">
              {description}
            </p>
          </div>

          <div className="flex sm:gap-[9px] items-center sm:mt-[30px] sm:flex-row flex-col gap-[4px]">
