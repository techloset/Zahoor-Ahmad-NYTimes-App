...
const NewsModal: React.FC<NewsModalProps> = ({
  ...
  return (
    <div className="w-full h-[calc(100%-5rem)] flex justify-center items-center z-50 bg-black/40 fixed top-20  left-0">
      <div className="sm:p-12 py-[35px] px-6 sm:rounded-[20px] rounded-[10px] max-h-[846px] sm:h-[596px] flex flex-col sm:flex-row sm:gap-[76px] relative bg-white w-[327px] sm:w-[1462px] ">
        <div
          onClick={closeModal}
        ...
        <div className="sm:max-w-[750px] sm:min-w-[750px]  w-[279px] sm:h-[500px] h-[347px] overflow-hidden">
        ...
        <div>
          ...
          <div className="flex sm:gap-[5px] mt-[5px] min-w-[94px] items-center sm:mt-[30px] sm:flex-row flex-col gap-[4px]">
            <p className="h-5 text-zinc-800 w-[94px] text-[13px] font-normal font-Poppins">
              {pubishedAt}
            </p>
            <p className="sm:h-5 opacity-70 text-zinc-800 text-[13px] font-normal font-Poppins">
              {byLine}
            </p>
          </div>
        </div>
